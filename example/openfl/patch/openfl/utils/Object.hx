...
@:forward() abstract Object(ObjectType) from ObjectType {
  ...
  public inline function propertyIsEnumerable(name: String): Bool {
    return
      (this != null && Reflect.hasField(this, name) && Std.is(Reflect.field(this, name), Iterable_));
  }
  ...
  @SuppressWarnings("checkstyle:FieldDocComment")
  @:arrayAccess @:noCompletion @:dox(hide) public inline function __set(key: String,
...
@SuppressWarnings("checkstyle:FieldDocComment")
@:keep private interface Iterator_<T> {
  public function hasNext(): Bool;
  public function next(): T;
}

@SuppressWarnings("checkstyle:FieldDocComment")
@:keep private interface Iterable_<T> {
