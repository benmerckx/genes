...
abstract Vector<T>(IVector<T>) {
  ...
  **/
  #if !flash
  public function new(length: Null<Int> = 0, fixed: Null<Bool> = false,
  ...
  **/
  #if (openfl < "9.0.0") @:dox(hide) #end public inline function filter(callback: T->
    Bool): Vector<T> {
  ...
  **/
  ...
  /**
    ...
    `searchElement` argument is not found, the return value is -1.
  **/
  public inline function lastIndexOf(searchElement: T,
      fromIndex: Null<Int> = null): Int {
  ...
  **/
  ...
  /**
    Array access
  **/
  @:noCompletion @:dox(hide) @:arrayAccess public inline function set(index: Int,
    value: T): T {
  ...
  **/
  public inline function slice(startIndex: Int = 0,
      endIndex: Null<Int> = null): Vector<T> {
  ...
  **/
  ...
  #if !flash
  @:to #if (!js && !flash) inline #end private static function toBoolVector<T: Bool>(t: IVector<T>,
    length: Int, fixed: Bool, array: Array<T>): BoolVector {
    return new BoolVector(length, fixed, cast array);
  }

  @:to #if (!js && !flash) inline #end private static function toIntVector<T: Int>(t: IVector<T>,
    length: Int, fixed: Bool, array: Array<T>): IntVector {
    return new IntVector(length, fixed, cast array);
  }

  @:to #if (!js && !flash) inline #end private static function toFloatVector<T: Float>(t: IVector<T>,
    length: Int, fixed: Bool, array: Array<T>): FloatVector {
    return new FloatVector(length, fixed, cast array, true);
  }

  #if !cs
  @:to #if (!js && !flash) inline #end private static function toFunctionVector<T: Function>(t: IVector<T>,
    length: Int, fixed: Bool,
      array: Array<T>): FunctionVector {
    return new FunctionVector(length, fixed, cast array);
  }
  #end

  @:to #if (!js && !flash) inline #end private static function toObjectVector<T: {}>(t: IVector<T>,
    length: Int, fixed: Bool,
...
@:dox(hide) private class BoolVector implements IVector<Bool> {
  ...
  public function slice(startIndex: Int = 0,
      endIndex: Null<Int> = null): IVector<Bool> {
    if (endIndex == null)
      endIndex = 16777215;
...
@:dox(hide) private class FloatVector implements IVector<Float> {
  ...
  @SuppressWarnings("checkstyle:Dynamic")
  public function new(length: Int = 0, fixed: Bool = false,
      array: Array<Dynamic> = null, forceCopy: Bool = false): Void {
    if (forceCopy) {
      __array = new Array();
      if (array != null)
        for (i in 0...array.length)
  ...
  public function slice(startIndex: Int = 0,
      endIndex: Null<Int> = null): IVector<Float> {
    if (endIndex == null)
      endIndex = 16777215;
...
@:dox(hide) private class FunctionVector implements IVector<Function> {
  ...
  public function new(length: Int = 0, fixed: Bool = false,
      array: Array<Function> = null): Void {
    if (array == null)
      array = new Array();
    __array = array;
  ...
  public function slice(startIndex: Int = 0,
      endIndex: Null<Int> = null): IVector<Function> {
    if (endIndex == null)
      endIndex = 16777215;
...
@:dox(hide) private class IntVector implements IVector<Int> {
  ...
  public function slice(startIndex: Int = 0,
      endIndex: Null<Int> = null): IVector<Int> {
    if (endIndex == null)
      endIndex = 16777215;
...
@:dox(hide) private class ObjectVector<T> implements IVector<T> {
  ...
  public function slice(startIndex: Int = 0,
      endIndex: Null<Int> = null): IVector<T> {
    if (endIndex == null)
      endIndex = 16777215;
...
abstract Vector<T>(VectorData<T>) from VectorData<T> {
  ...
  public inline function concat(?a: Vector<T>): Vector<T> {
    ...
    return
      VectorData.ofArray(untyped __js__("Array.prototype.concat.call")(this, a));
  }
  ...
  public function filter(callback: T->Bool): Vector<T> {
    return
      VectorData.ofArray(untyped __js__("Array.prototype.filter.call")(this, callback));
  }
  ...
  public inline function slice(startIndex: Int = 0,
      endIndex: Null<Int> = 16777215): Vector<T> {
    // return cast this.slice (pos, end);
    return
      VectorData.ofArray(untyped __js__("Array.prototype.slice.call")(this, startIndex, endIndex));
  }
  ...
  public inline function splice(pos: Int, len: Int): Vector<T> {
    ...
    return
      VectorData.ofArray(untyped __js__("Array.prototype.splice.call")(this, pos, len));
  }
...
@:keep class VectorData<T> implements ArrayAccess<T> {
  ...
  @:noCompletion private static function __init__() {
    ...
    Object.setPrototypeOf(VectorData.prototype, _VectorData.prototype);
		");
  }
  ...
  @:noCompletion private function construct(instance: Dynamic, ?length: Int,
      ?fixed: Bool) {
    if (length != null) {
      // for (i in 0...length) {
  ...
  public function slice(startIndex: Int = 0,
      endIndex: Null<Int> = null): VectorData<T> {
    if (endIndex == null)
      endIndex = 16777215;
    return
      VectorData.ofArray(untyped __js__("Array.prototype.slice.call (this, startIndex, endIndex)"));
...
abstract Vector<T>(VectorData<T>) {
  ...
  public inline function new(?length: Int, ?fixed: Bool,
      ?array: Array<T>): Void {
    if (array != null) {
      this = VectorData.ofArray(array);
  ...
  public inline function slice(pos: Int = 0,
      end: Null<Int> = 16777215): Vector<T> {
